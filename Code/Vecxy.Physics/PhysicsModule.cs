...
public sealed class PhysicsSceneSystem : ASceneSystem
{
    ...
    private sealed class BodyBinding(SceneObject sceneObject)
    {
        ...
        public JitterRigidBody? NativeBody { get; set; }
    ...
    private sealed class SceneRuntime : IDisposable
    {
        ...
        public Dictionary<JitterRigidBody, BodyBinding> BodiesByNativeBody { get; } = [];
    ...
    IPhysicsSystem
{
    ...
    public void OnInitialize()
    {
        ...
        configs.Register<PhysicsConfig>();
